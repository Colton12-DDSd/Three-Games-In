export const CARD_SETS = {
  arenas: {
    ...
    prompts: [
      ...
      "Get a triple kill",
      "Die in a round",
      "Deal the most damage in a round",
      "Win a 1v1",
      "Pick an augment",
  ...
  risk_of_rain_2: {
    ...
    prompts: [
      ...
      "Scrap an item",
      "Find a shrine",
      "Use a Shrine of Chance",
      "Use a Shrine of Blood",
      "Use a Shrine of the Mountain",
      "Find a lunar pod",
      "Pick up a lunar item",
      ...
      "Use your equipment",
      "Find a teleporter",
      "Start the teleporter event",
      "Finish the teleporter event",
